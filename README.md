...
In this project you will combine your Python, SQL and API skills and use them in combination with each other.  
...
6. Prioritize using branches and pull requests reviewed by other team members, so the `main` remains the "source of truth"

7.  Each team will get a new project schema in our DB. Members will have write and read rights.
...
4. Transform the original data to insightful tables which will allow you to visualize flight events and weather changes over time, to summarize useful statistics  in (e.g. to compare regular flight traffic averages with the metrics during the weather extremes)
...
6. With pandas you have multiple options:
     ...
     **a.** Perform a basic EDA on the initial data. The EDA should reflect what data is your project based on.  
     **b.** Come up with different hypotheses regarding your available data. You should ask questions like 
